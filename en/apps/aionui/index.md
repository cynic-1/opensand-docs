...
## OpenSand Configuration Steps

1. **Copy API key in OpenSand**
...
4. **Configure API Information**
   ...
   - API Key: Paste the API Key copied from OpenSand console

5. **Add Models**
   - Select the model to add from the dropdown
   - Model name should match the model name configured in OpenSand
