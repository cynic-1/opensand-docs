---
title: "FluentRead"
source: "https://opensand.ai/en/docs/apps/fluent-read"
...
In the System Settings -> Chat Settings of the OpenSand console, you can add
...
### Import Configuration from OpenSand Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the OpenSand console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the OpenSand configuration in FluentRead will be enabled.
...
| ------------------- | --------------------------------------- |
| Translation Service | OpenSand                                  |
| Access Token        | OpenSand Key                              |
| OpenSand Endpoint     | OpenSand Deployment Address (without /v1) |
