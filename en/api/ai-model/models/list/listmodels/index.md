---
title: "Model List"
source: "https://opensand.ai/en/docs/api/ai-model/models/list/listmodels"
adapted_for: "OpenSand"
adapted_at: "2026-05-22T02:54:35.130Z"
---
# Model List

List models available to the current API key. Call this before configuring a new tool to confirm model IDs.
...
Use it to discover available models, check exact model IDs, and confirm whether a key can access a model.
...
- Different keys may see different models depending on groups, quota, or permissions.
