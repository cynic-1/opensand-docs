...
source: "https://opensand.ai/en/docs/api/ai-model/videos/seedance"
adapted_for: "OpenSand"
adapted_at: "2026-05-22T02:54:35.131Z"
---
# Seedance Video Generation

Seedance video models use OpenSand's unified asynchronous task API. Video generation usually takes longer than text generation, so the API returns a task ID first and you poll for the result.
